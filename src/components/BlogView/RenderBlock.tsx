...
export const RenderBlock: React.FC<Props> = ({ block }) => {
  ...
  switch (type) {
    ...
    case "heading_1":
      return <Title order={1}><NotionText text={value.text} /></Title>
    case "heading_2":
      return <Title order={2}><NotionText text={value.text} /></Title>
    case "heading_3": {
      return <Title order={3}><NotionText text={value.text} /></Title>
    }
